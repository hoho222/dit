            ...
            <div class="box-body">
              <ul class="todo-list">
                <li>
                  ...
                  <!-- todo text -->
                  <span class="text">목표달성 탬플릿 디자인 완성되면 페이스북 공유 기능 붙이기</span>
                  <!-- Emphasis label -->
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">어드민 인덱스(통계 및 현황 & 투 두 리스트 DB로 연동시켜서 보여주기)</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">데이터에 오랜만에 접속 시 나는 DB에러 고치기(하이월드 마찬가지)</span>
