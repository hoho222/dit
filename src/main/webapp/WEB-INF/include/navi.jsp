...
<!-- Morris chart -->
<link rel="stylesheet" href="/doto/css/morris.css">
<!-- jvectormap -->
<link rel="stylesheet" href="/doto/css/jquery-jvectormap-1.2.2.css">
<!-- bootstrap wysihtml5 - text editor -->
<link rel="stylesheet" href="/doto/css/bootstrap3-wysihtml5.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="${pageContext.request.contextPath}/admin/index" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>DIT</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
      	<div class="pull-left image">
      		<img src="/doto/resources/imgs/logo.png" class="img-circle" alt="logo Image">
      	</div>
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="${pageContext.request.contextPath}/admin/penalty"><i class="fa fa-files-o"></i> <span>패널티상품 관리</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o">  프론트 회원</i></a></li>
